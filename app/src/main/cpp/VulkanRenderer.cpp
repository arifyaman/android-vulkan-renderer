...
void VulkanRenderer::createRenderPass() {
    ...
    colorAttachment.finalLayout = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR; // Direct to swapchain
    ...
    // No resolve attachment needed without MSAA
    ...
    std::array<VkAttachmentDescription, 2> attachments = {colorAttachment, depthAttachment}; // Only 2 attachments now
    ...
    aout << "Render pass created without MSAA (direct to swapchain)" << std::endl;
}
...
void VulkanRenderer::createFramebuffers() {
    ...
    for (size_t i = 0; i < swapChainImageViews.size(); i++) {
        ...
        // No MSAA mode: swapchain image + depth
